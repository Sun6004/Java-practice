...
// 서버에서 보낸 환영 메세지를 받아서 화면에 출력한다.

public class tcpClient01 {
	public static void main(String[] args) throws UnknownHostException, IOException {
		/*
		 *  현재의 컴퓨터를 나타내는 방법
		 *  1. 원래의 IP주소: 예)192.168.146.72
		 *  2. 지정된 IP주소: 127.0.0.1
		 *  3. 원래의 컴퓨터 이름: 예) Desktop-...
		...
		//Socket socket = new Socket("상대방의 IP주소",상대방의 Port주소);
		Socket socket = new Socket("localhost",7777);
		
		//이 부분부터는 서버와 연결이 완료된 상태이어야만 실행된다.
		System.out.println("서버에 연결되었습니다..");
		System.out.println();
		
		// 상대방(서버)에서 보내온 메세지를 받아서 출력하기
